    ...
    public partial class addseeds : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, new DateTime(2022, 12, 13, 10, 15, 48, 384, DateTimeKind.Local).AddTicks(7449), "user", "User Manager", null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "Name", "Permissions", "UpdatedAt" },
                values: new object[] { 1L, new DateTime(2022, 12, 13, 10, 15, 48, 384, DateTimeKind.Local).AddTicks(7363), "Super Admin", "{}", null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedAt", "Name", "Permissions", "UpdatedAt" },
                values: new object[] { 2L, new DateTime(2022, 12, 13, 10, 15, 48, 384, DateTimeKind.Local).AddTicks(7365), "General Admin", "{}", null });

            migrationBuilder.InsertData(
                table: "SuperAdmin",
                columns: new[] { "Id", "Address", "CreatedAt", "Email", "Image", "Name", "Password", "Phone", "RoleId", "Status", "UpdatedAt" },
                values: new object[] { 1L, " 590 CMT8", new DateTime(2022, 12, 13, 10, 15, 48, 384, DateTimeKind.Local).AddTicks(7464), "Admin@gmail.com", "default.jpg", "Super Admin", "123456", " 0123456789", 1L, (byte)1, null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "CreatedAt", "Email", "Image", "Name", "Password", "Phone", "RoleId", "Status", "UpdatedAt" },
                values: new object[] { 1L, " 590 CMT8", new DateTime(2022, 12, 13, 10, 15, 48, 384, DateTimeKind.Local).AddTicks(7481), "Admin2@gmail.com", "default.jpg", "General Admin", "123456", " 0123456789", 2L, (byte)1, null });
