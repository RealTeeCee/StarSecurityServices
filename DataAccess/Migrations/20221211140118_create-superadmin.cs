        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Permissions = table.Column<string>(type: "text", maxLength: 255, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesBranches", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoriesBranches_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriesBranches_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersBranches_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersBranches_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesBranches_BranchId",
                table: "CategoriesBranches",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriesBranches_CategoryId",
                table: "CategoriesBranches",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersBranches_BranchId",
                table: "UsersBranches",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersBranches_UserId",
                table: "UsersBranches",
                column: "UserId");
