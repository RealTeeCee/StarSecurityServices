    ...
    public partial class initazuredb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientDetails_Services_ServiceId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2a1a3743-a6eb-45fb-8fb3-2e5e5898b027", "33e76d82-4d26-4009-ba7f-2c8d2be07998", "SuperAdmin", "SUPERADMIN" },
                    { "5480a8dc-07e4-4ea4-946e-d216e89d0c98", "57d533ce-4715-4532-9218-cd469e6681f4", "Admin", "ADMIN" },
                    { "921dea56-dd90-4f32-8889-418caf510e5f", "3b8af046-3be2-4471-8d17-e988cc3bf111", "Employee", "EMPLOYEE" },
                    { "e37a783c-ac89-4e68-a43c-b024878bf152", "9934fe9f-2ced-4730-a4a9-8a43664456c3", "GeneralAdmin", "GENERALADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "a0568161-10a5-4b5a-ad53-8d9ce9479627", 0, "Some Address", "10dc164b-b0d6-4730-b308-7938a878c434", new DateTime(2023, 3, 21, 16, 15, 21, 0, DateTimeKind.Local).AddTicks(3507), "User", "nguyenngocnguyen.rtc@starsec.com", false, "default.jpg", false, null, "Nguyễn Ngọc Nguyên", "NGUYENNGOCNGUYEN.RTC@STARSEC.COM", "TEECEE", "AQAAAAEAACcQAAAAEHt+oM2o4UWcWkZOIV3weEoKuTc7trsVglYaL1dx/bgB6qW4c5XVasTD7hfiMzdZNQ==", null, null, false, "b93ddbb9-4a73-4352-bf0d-11002c092f9a", (byte)1, false, null, "TeeCee" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "590 Đ. Cách Mạng Tháng 8, Phường 11, Quận 3, Thành phố Hồ Chí Minh", new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(220), "hcm@gmail.com", "https://www.facebook.com/", "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3919.3236076453527!2d106.6645791!3d10.7865081!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752ed2392c44df%3A0xd2ecb62e0d050fe9!2zRlBUIEFwdGVjaCBIQ00gLSBI4buHIFRo4buRbmcgxJDDoG8gVOG6oW8gTOG6rXAgVHLDrG5oIFZpw6puIFF14buRYyBU4bq_IChTaW5jZSAxOTk5KQ!5e0!3m2!1svi!2s!4v1672237519769!5m2!1svi!2s", "security-branch1.jpg", "https://www.instagram.com/", "10.787249", "106.666595", "Hồ Chí Minh", "0987654321", "Mon - Fri : 8:00 AM to 5:00 PM", "https://www.twitter.com/", null, "https://www.youtube.com/" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(411), "default.jpg", "Security Service", null, "security-service", null },
                    { 2L, new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(413), "default.jpg", "Vacancy Service", null, "vacancy-service", null },
                    { 3L, new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(415), "default.jpg", "Cash Service", null, "cash-service", null },
                    { 4L, new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(416), "default.jpg", "Train Service", null, "train-service", null },
                    { 5L, new DateTime(2023, 3, 21, 16, 15, 21, 9, DateTimeKind.Local).AddTicks(419), "default.jpg", "Electronic Service", null, "electronic-service", null }
                });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "2a1a3743-a6eb-45fb-8fb3-2e5e5898b027", "a0568161-10a5-4b5a-ad53-8d9ce9479627" });

            migrationBuilder.InsertData(
                table: "UserBranchs",
                columns: new[] { "Id", "BranchId", "UserId" },
                values: new object[] { 1L, 1L, "a0568161-10a5-4b5a-ad53-8d9ce9479627" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientDetails_ServiceId",
                table: "ClientDetails",
                column: "ServiceId");
